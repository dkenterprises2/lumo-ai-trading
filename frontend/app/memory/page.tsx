...
import { TradeMemoryDashboard } from "@/components/learning/TradeMemoryDashboard";
      ...
      <div className={`flex-1 min-w-0 p-4 transition-all duration-300 lg:p-6 ${sidebarCollapsed ? "ml-20" : "ml-64"}`}>
        ...
        <main className="space-y-6">
          <div className="border-b border-gray-800 pb-4">
            <h1 className="text-2xl font-bold text-white tracking-tight">Phase 44.4 — Closed-Loop Self-Learning Trade Memory &amp; Continuous Improvement</h1>
            <p className="text-xs text-gray-400 mt-1">
              Deterministic experience store, 13-point post-mortem RCA, multi-memory hierarchy, counterfactuals, and empirical lesson validation.
            </p>
          </div>

          <TradeMemoryDashboard />
        </main>
