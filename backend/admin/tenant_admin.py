...
class TenantAdminConsole:
    ...
    def list_users(self) -> List[Dict[str, Any]]:
        return [
            {"user_id": 1, "email": "jiodkd@gmail.com", "role": "SUPER_ADMIN", "tenant_id": "ORG-101", "status": "ACTIVE"},
            {"user_id": 2, "email": "trader@alphaquant.com", "role": "TRADER", "tenant_id": "ORG-101", "status": "ACTIVE"}
        ]
