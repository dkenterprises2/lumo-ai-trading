...
class BybitAdapter(BaseExchangeAdapter):
    """Bybit Spot & Linear Perpetual Exchange Adapter."""
    ...
    def get_exchange_name(self) -> str:
        return "BYBIT_TESTNET" if self.testnet else "BYBIT_LIVE"
    ...
    def create_order(
        ...
        c_id = client_order_id or f"BYBIT_{int(time.time()*1000)}_{uuid.uuid4().hex[:4]}"
